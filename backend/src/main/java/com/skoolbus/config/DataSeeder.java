...
public class DataSeeder {
    @Bean
    CommandLineRunner seedDemoData(BusRepository buses, StudentRepository students, NotificationEventRepository events, IncidentRepository incidents) {
        return args -> {
            ...
            students.saveAll(List.of(student("Aarav Sharma", "Grade 4", "Maple Apartments", "Neha Sharma", "+91 90000 10001", "PICKED_UP_FROM_STOP", "WAITING_AT_SCHOOL", bus), student("Maya Iyer", "Grade 2", "Lake View Gate", "Priya Iyer", "+91 90000 10002", "PICKED_UP_FROM_STOP", "EXTRA_CLASS", bus)));
